...
class Icon(QWidget):
    def __init__(self):
        ...
        self.layout = QHBoxLayout(self)
        self.layout.setAlignment(Qt.AlignLeft)
        self.button = Button(button_type='primary', icon=ArcoIcon.Plus.svg)
...
class Shape(QWidget):
    def __init__(self):
        ...
        self.layout.setAlignment(Qt.AlignLeft)
        self.button = Button(button_type='primary', icon=ArcoIcon.Plus.svg)
        self.button1 = Button(button_type='primary', icon=ArcoIcon.Plus.svg, shape='circle')
...
class Button_Group(QWidget):
    def __init__(self):
        ...
        self.button1 = Button(icon=ArcoIcon.Down.svg)
        ...
        self.button3 = Button(button_type='secondary', icon=ArcoIcon.More.svg)
        ...
        self.button5 = Button(button_type='primary', icon=ArcoIcon.Down.svg)
        self.button_group2 = ButtonGroup([self.button4, self.button5])
        self.layout.addWidget(self.button_group2, 1, 0, Qt.AlignLeft)

        self.button6 = Button('Prev', 'primary', ArcoIcon.Left.svg, 'round')
        self.button7 = Button('Next', 'primary', ArcoIcon.Right.svg, 'round', icon_right=True)
        self.button_group3 = ButtonGroup([self.button6, self.button7])
        self.layout.addWidget(self.button_group3, 2, 0, Qt.AlignLeft)

        self.button8 = Button(button_type='primary', icon=ArcoIcon.Star.svg)
        self.button9 = Button(button_type='primary', icon=ArcoIcon.Message.svg)
        self.button10 = Button(button_type='primary', icon=ArcoIcon.Settings.svg)
        ...
        self.button11 = Button('Favorite', 'primary', ArcoIcon.Star.svg)
        self.button12 = Button('Setting', 'primary', ArcoIcon.Settings.svg)
